...
class FlipkartScraper:
    ...
    def get_top_reviews(self,product_url,count=2):
        '''
        Get the top reviews of the product
        '''
        ...
        try:
            ...
            # review_blocks = soup.select("div._1psv1zeb9._1psv1ze0")
            # print("Review Blocks:", len(review_blocks))
            reviews = []
            seen = set()
            ...
            #     break
            #     review = block.select_one(
            #                                "div.v1zwn211.v1zwn26._1psv1zeb9._1psv1ze0"
            #                               )
            review_tag = soup.select(
                     "div.v1zwn21l.v1zwn26._1psv1zeb9._1psv1ze0"
                    )
